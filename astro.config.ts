    ...
    integrations: [basePathPostProcessor(BASE), stainlessDocs({
      ...
      experimental: {
        ...
        starlightCompat: {
          ...
          plugins: [
              starlightLlmsTxt(),
              // Internal link/anchor validation is handled by the built-site
              // checker (scripts/check-built-links.mjs, run via `pnpm lint:links`),
              // which validates rendered HTML instead of the markdown AST.
            ],
        },
      },
      tabs: [
