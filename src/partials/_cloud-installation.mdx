...
<Step title="Select the pricing option that suits you and click `View purchase options`"></Step>

<Step title="Review and configure the purchase details, then click `Subscribe`"></Step>
