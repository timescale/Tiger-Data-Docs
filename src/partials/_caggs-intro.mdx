...
![Reduced data calls with {C.CAGG}s][reduced-data-calls-with-caggs]
...
[real-time-aggregates]: /use-timescale/continuous-aggregates/real-time-aggregates/
[reduced-data-calls-with-caggs]: ../assets/images/continuous-aggregate.webp
