...
Also, the [columnstore policy](/reference/timescaledb/hypercore/add_columnstore_policy) you set is less important, `INSERT` already produces compressed chunks. 
