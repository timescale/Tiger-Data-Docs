...
import imgBackfillConsistencyLight from "../assets/images/migrate/dual-write-and-backfill/hypertable_backfill_consistency.png";
import imgBackfillConsistencyDark from "../assets/images/migrate/dual-write-and-backfill/hypertable_backfill_consistency-dark.png";
...
<ThemeImage light={imgBackfillConsistencyLight} dark={imgBackfillConsistencyDark} alt="Hypertable dual-write time ranges: missing writes, late-arriving data, and consistency range" />
