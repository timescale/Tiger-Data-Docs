...
import imgBackfillConsistency from "../assets/images/migrate/dual-write-and-backfill/hypertable_backfill_consistency.png";
...
<Image src={imgBackfillConsistency} alt="Hypertable dual-write time ranges: missing writes, late-arriving data, and consistency range" />
