...
<Step title={`In ${C.CONSOLE}, choose the ${C.SERVICE_SHORT}`}></Step>

<Step title="Click `Operations` > `Exporters`"></Step>

<Step title="Select the exporter, then click `Attach exporter`"></Step>

<Step title={`If you are attaching a first \`Logs\` data type exporter, restart the ${C.SERVICE_SHORT}`}></Step>
...
<Step title="Next to the exporter you want to edit, click the menu > `Edit`"></Step>

<Step title="Edit the exporter fields and save your changes">
...
<Step title={`Disconnect the data exporter from your ${C.SERVICE_LONG}s`}>
...
<Step title="Delete the exporter on the project level">
