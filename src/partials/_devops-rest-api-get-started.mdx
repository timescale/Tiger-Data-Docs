...
[{C.REST_LONG}](/reference/tiger-cloud-api) is a comprehensive RESTful API you use to manage {C.CLOUD_LONG} resources
...
And that is it, you are ready to use the [{C.REST_LONG}](/reference/tiger-cloud-api) to manage your
