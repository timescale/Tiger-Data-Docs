...
<NumberedList>
<NumberedItem title="Validate the migrated data">
...
<NumberedItem title="Stop app downtime">
Once you are confident that your data is successfully replicated, configure your apps
to use your {C.SERVICE_LONG}.
</NumberedItem>

<NumberedItem title="Cleanup resources associated with live-migration from your migration machine">
