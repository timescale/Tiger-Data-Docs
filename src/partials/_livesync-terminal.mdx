...
To convert a partitioned table to a hypertable, follow [Convert partitions and tables with time-series data into hypertables](/migrate/livesync-for-postgresql/#convert-partitions-and-tables-with-time-series-data-into-hypertables).
