...
- Install the [{C.PG} client tools][psql] on your sync machine.
...
[convert-partitions-and-tables-with-time-series-data-into-hypertables-link]: /migrate/livesync-for-postgresql/#convert-partitions-and-tables-with-time-series-data-into-hypertables
