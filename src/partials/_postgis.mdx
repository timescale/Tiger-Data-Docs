...
<NumberedItem title="Analyze geospatial data with PostGIS">
...
1.  To fetch the latest logged cases of all states using the SkipScan feature, replace `<Interval_Time>` with the number of
