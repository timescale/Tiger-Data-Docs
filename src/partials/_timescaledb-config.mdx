...
[continuous aggregate](/use-timescale/continuous-aggregates/), and generate fewer Write-Ahead Logs (WAL). Only works for continuous aggregates that don't have compression enabled.
