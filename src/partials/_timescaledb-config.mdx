...
import ConfigCloudSelf from "./_cloud_self_configuration.mdx";
...
[continuous aggregate](/build/continuous-aggregates/create-a-continuous-aggregate), and generate fewer Write-Ahead Logs (WAL). Only works for continuous aggregates that don't have compression enabled.
