...
<Step title="Use your file manager to decompress the downloaded dataset, and take a note">

of the path to the `metrics.csv` file.

</Step>

<Step title="At the psql prompt, copy the data from the `metrics.csv` file into">
...
<Step title="You can check that the data has been copied successfully with this command:">
