...
<NumberedItem title="Use your file manager to decompress the downloaded dataset, and take a note">

of the path to the `metrics.csv` file.

</NumberedItem>

<NumberedItem title="At the psql prompt, copy the data from the `metrics.csv` file into">
