...
Create a {C.CAGG} called `kwh_day_by_day` for energy consumption:
...
Create a {C.CAGG} called `kwh_hour_by_hour` for energy consumption:
...
Add a refresh policy to keep the {C.CAGG} up-to-date:
