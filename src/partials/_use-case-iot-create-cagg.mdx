...
<NumberedList>
<NumberedItem title="Monitor energy consumption on a day-to-day basis">

1. Create a {C.CAGG} called `kwh_day_by_day` for energy consumption:
...
<NumberedItem title="Monitor energy consumption on an hourly basis">

1. Create a {C.CAGG} called `kwh_hour_by_hour` for energy consumption:
...
1. Add a refresh policy to keep the {C.CAGG} up-to-date:
...
<NumberedItem title="Analyze your data">

Now you have made {C.CAGG}s, you can use them to perform analytics on your data.
