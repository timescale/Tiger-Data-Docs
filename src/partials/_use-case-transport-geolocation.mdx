...
<Step title={`Connect to your ${C.SERVICE_LONG} and add the PostGIS extension:`}>
...
<Step title="Add geometry columns for pick up and drop off locations:">
...
<Step title="Convert the latitude and longitude points into geometry coordinates that work with PostGIS:">
...
<Step title="Create a geolocalization dashboard">
...
<Step title="Customize the visualization">
