...
<ol type="a">
<li>In Grafana, create a new dashboard that is connected to your {C.SERVICE_LONG} data source with a Geomap visualization.</li>
<li>

In the `Queries` section, select `Code`, then select the Time series `Format`.
...
<li>Zoom into your map to see the visualization clearly.</li>
</ol>
