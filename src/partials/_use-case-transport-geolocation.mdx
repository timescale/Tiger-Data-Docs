...
import imgConfigureDashboard from "../assets/images/learn/tutorials/use-case-rta-grafana-timescale-configure-dashboard.png";
import imgHeatmap from "../assets/images/learn/tutorials/use-case-rta-grafana-heatmap.png";
