...
originated where. As {C.TIMESCALE_DB} is compatible with all {C.PG} extensions, use [PostGIS][postgis] to slice 
...
[real-time-analytics-geolocation-1]: ../assets/images/use-case-rta-grafana-heatmap.webp
