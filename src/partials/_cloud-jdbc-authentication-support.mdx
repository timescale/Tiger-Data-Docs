...
When connecting to {C.CLOUD_LONG} with a Java Database Connectivity (JDBC)
driver, you might get this error message.

Your {C.CLOUD_LONG} authentication type doesn't match your JDBC driver's
...
option, you can change the authentication type for your {C.SERVICE_LONG}
...
[password-reset]: /deploy/tiger-cloud/tiger-cloud-aws/service-management/service-management#reset-your-service-password
