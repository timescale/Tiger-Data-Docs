...
| {C.READ_REPLICA_CAP}s with load balancing for seamless read scaling | ✅ | ✅ | Manual | Manual |
...
| Continuous incremental backup and automated restore | ✅ | ✅ | Scheduled | Manual |
...
| Connection monitoring and management | ✅ | ✅ | Manual | Manual |
