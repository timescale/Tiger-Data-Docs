...
[Designing Your Database Schema: Wide vs. Narrow {C.PG} Tables][blog-wide-vs-narrow].
...
[join-lateral]: /tutorials/cookbook/#join-lateral
[select-distinct-on]: /tutorials/cookbook/#select-distinct-on
[setup-a-narrow-table-format]: /tutorials/cookbook/#narrow-table-format-example
