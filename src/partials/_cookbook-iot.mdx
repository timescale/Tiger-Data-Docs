...
This section contains short recipes for common IoT scenarios:
...
you with [hyperfunctions](/learn/hyperfunctions/about-hyperfunctions) and other tools to help you work with this data. 
...
structure defined in [Narrow table format example](#narrow-table-format-example) as a reference
