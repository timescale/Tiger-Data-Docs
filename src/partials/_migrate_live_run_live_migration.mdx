...
1. **Create a snapshot image of your source database in your {C.SERVICE_LONG}**
...
1. **Synchronize data between your source database and your {C.SERVICE_LONG}**
   ...
   table. For more information, see the [Hypertable docs](/use-timescale/hypertables/).   
