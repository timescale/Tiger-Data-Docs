...
tables. For more information, see the [hypertable docs](/learn/hypertables/understand-hypertables).
...
1. Stop your app writing to the source database, then let the remaining transactions
