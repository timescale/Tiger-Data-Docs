...
*   Install the [{C.PG} JDBC driver][pg-jdbc-driver].
...
1.  Import the {C.PG} JDBC driver. If you are using a dependency manager,
   include the [{C.PG} JDBC Driver][pg-jdbc-driver-dependency] as a
   dependency.
