import ExplainPgDumpFlags from "./_migrate_explain_pg_dump_flags.mdx";
...
- `--snapshot` is used to specified the synchronized [snapshot](https://www.postgresql.org/docs/current/functions-admin.html#FUNCTIONS-SNAPSHOT-SYNCHRONIZATION) when
