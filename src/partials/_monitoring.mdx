...
![Monitoring suite in Tiger Cloud](https://assets.timescale.com/docs/images/tiger-cloud-console/tiger-monitoring-workflow-diagram.svg)
...
- **For storage, I/O, and bandwidth**: these resources depend on your storage type and {C.IO_BOOST} settings. The standard high-performance storage gives you 16TB of compressed data on a single server, regardless of the number of hypertables in your {C.SERVICE_SHORT}. See [About storage tiers](/build/data-management/storage/about-storage-tiers) for how to change the available storage, I/O, and bandwidth.
...
![Jobs](https://assets.timescale.com/docs/images/tiger-on-azure/tiger-console-jobs-table.png)

Click `Timeline` at the top right to see the recent job runs with their statuses. Select the timeframe from 1 to 24 hours:

![Jobs timeline](https://assets.timescale.com/docs/images/tiger-on-azure/tiger-console-jobs-timeline-view.png)
...
![Recommendations](https://assets.timescale.com/docs/images/tiger-cloud-console/recommendations-tiger-cloud.png)
