...
<Step title={`In ${C.CONSOLE}, open Exporters`}></Step>

<Step title="Click `New exporter`"></Step>
...
<Step title="In AWS, navigate to IAM > Identity providers, then click `Add provider`."></Step>
...
<Step title="Click `Add provider`."></Step>

<Step title="In AWS, navigate to IAM > Roles, then click `Create role`."></Step>
...
<Step title="Select the AWS Region your CloudWatch services run in, then click `Create exporter`."></Step>
