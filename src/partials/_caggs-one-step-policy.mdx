...
information, see the APIs for [adding policies](/api/continuous-aggregates/add_policies/), [altering
policies](/api/continuous-aggregates/alter_policies/), and [removing policies](/api/continuous-aggregates/remove_policies/). Note that
