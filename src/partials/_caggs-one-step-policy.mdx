...
[add-retention-policies]: /api/continuous-aggregates/add_policies/
[alter-policies]: /api/continuous-aggregates/alter_policies/
[remove-policies]: /api/continuous-aggregates/remove_policies/
