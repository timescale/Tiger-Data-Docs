...
Shoutout to **Mathias Ose** and **Christopher Piggott** for this tutorial. 
...
If you split the query into two parts using CTEs, you can `materialize` the hypertable lookup and force {C.PG} to perform it only once. 
