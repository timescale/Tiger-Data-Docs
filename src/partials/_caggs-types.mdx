...
[Continuous aggregates](/use-timescale/continuous-aggregates/about-continuous-aggregates/) are a {C.TIMESCALE_DB}-only feature. They work in
...
[Real-time aggregates](/use-timescale/continuous-aggregates/real-time-aggregates/) are a {C.TIMESCALE_DB}-only feature. They are
