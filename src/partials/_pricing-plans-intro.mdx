...
{C.PRICING_PLAN}s provide more value, flexibility, and efficiency for your business.
...
<ThemeImage light={imgTigerPricingLight} dark={imgTigerPricingDark} alt="pricing plans" />

This page explains pricing plans for {C.CLOUD_LONG}, and how to easily manage your {C.ACCOUNT_LONG}.

{C.PRICING_PLAN_CAP}s give you:
...
* **Improved scalability**: as your business grows, so do your demands. {C.PRICING_PLAN_CAP}s scale with
...
* **Greater flexibility**: we know that one size doesn't fit all. {C.PRICING_PLAN_CAP}s give you the
  flexibility to choose the features and support levels that best match your business
  and engineering requirements. The ability to add features like {C.IO_BOOST} and customize your {C.PRICING_PLAN} means you can tailor {C.SERVICE_LONG}s to fit your specific needs.
...
Using {C.SELF_LONG} and our open-source products is still free.
