...
[Twelve Data](https://twelvedata.com/). A direct download link is provided below.
...
<NumberedItem title="Download the `real_time_stock_data.zip` file. The file contains two `.csv`">
