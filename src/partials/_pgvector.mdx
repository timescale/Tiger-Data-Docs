...
*   Python installed.
*   The [pgvector repository](https://github.com/timescale/vector-cookbook/tree/main/openai_pgvector_helloworld) cloned.
*   An [OpenAI developer account](https://platform.openai.com/overview).
