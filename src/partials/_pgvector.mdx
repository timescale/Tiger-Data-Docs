...
<NumberedItem title="Using the pgvector extension to create a chatbot">
...
1.  To insert these embeddings into your {C.SERVICE_LONG} using the `pgvector` extension,
...
1.  To query the embeddings that you inserted in to your {C.SERVICE_LONG}, open an editor of
