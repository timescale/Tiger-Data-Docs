...
<Step title={`In the ${C.CONSOLE}, click \`Create service\`.`}></Step>

<Step title="Click `Download the cheatsheet` to download an SQL file that contains the">
...
<Step title="On your local system, at the command prompt, connect to the service using">
