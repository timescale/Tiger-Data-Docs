...
[refresh-policy]: /use-timescale/continuous-aggregates/refresh-policies/
[reordering]: /api/hypertable/add_reorder_policy/
[retention-policy]: /use-timescale/data-retention/create-a-retention-policy/
