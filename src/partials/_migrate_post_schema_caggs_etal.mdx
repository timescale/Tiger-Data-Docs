...
<Step title="At the command prompt, dump the schema post-data from your source database">
...
<Step title="Restore the dumped schema post-data from the `dump_post_data.dump` file into">
...
<Step title="Connect to your source database:">
...
<Step title="Get a list of your existing continuous aggregate definitions:">
...
<Step title="Recreate each continuous aggregate definition:">
...
<Step title="Get a list of your existing policies. This query returns a list of all your">
...
<Step title="Recreate each policy. For more information about recreating policies, see">
