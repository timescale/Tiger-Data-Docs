...
the sections on [continuous-aggregate refresh policies](/use-timescale/continuous-aggregates/refresh-policies/),
[retention policies](/use-timescale/data-retention/create-a-retention-policy/), [Hypercore policies](/use-timescale/hypercore/real-time-analytics-in-hypercore/), and [reorder policies](/api/hypertable/add_reorder_policy/).
