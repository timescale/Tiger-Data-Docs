...
In this section, you use the helpers in the {C.TIMESCALE_DB} gem to create and manage a [hypertable][hypertables-section].
...
* Learn more about the [{C.TIMESCALE_DB} gem][timescale_db-gem].
