...
<Step title={`Create a new Rails app configured for ${C.PG}`}>
...
<Step title={`Install the ${C.TIMESCALE_DB} gem`}>
...
<Step title={`Connect your app to your ${C.SERVICE_LONG}`}>
...
<Step title="Generate a migration to create the page loads table">
...
<Step title="Add hypertable options">
...
<Step title="Create a `PageLoad` model">
...
<Step title="Create a controller to handle page loads">
...
<Step title="Generate some test data">
...
<Step title={`Insert the generated data into your ${C.SERVICE_LONG}`}>
...
<Step title={`Validate the test data in your ${C.SERVICE_LONG}`}>
