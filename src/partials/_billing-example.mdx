...
includes an itemized cost accounting for each {C.SERVICE_LONG} and any additional charges.

{C.CLOUD_LONG} charges are based on consumption and your pricing plan:
...
For example, over the last month your {C.SERVICE_LONG} has been running compute for 500 hours total:
...
additional charges. These charges are clearly marked in your billing snapshot in {C.CONSOLE}.
