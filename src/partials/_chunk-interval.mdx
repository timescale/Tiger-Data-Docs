...
You set `chunk_interval` when you [create a {C.HYPERTABLE}](/api/hypertable/create_table/), or by calling 
[`set_chunk_time_interval`](/api/hypertable/set_chunk_time_interval/) on an  existing hypertable.
