...
import EA1125 from "./_early_access_11_25.mdx";
import SINCE010 from "./_since_0_1_0.mdx";
import SINCE040 from "./_since_0_4_0.mdx";
import SINCE050 from "./_since_0_5_0.mdx";
...
<NumberedItem title="Install pg_textsearch">
...
1. **Enable the extension on your {C.SERVICE_LONG}**
...
<NumberedItem title="Enable parallel indexing">
...
<NumberedItem title="Optimize search queries">
...
<NumberedItem title="Build hybrid search">

1. **Enable the [vectorscale](/ai/sql-interface-for-pgvector-and-timescale-vector#installing-the-pgvector-and-pgvectorscale-extensions) extension on your {C.SERVICE_LONG}**
   ```sql
...
1. **Perform hybrid search using [reciprocal rank fusion](https://en.wikipedia.org/wiki/Mean_reciprocal_rank)**
...
<NumberedItem title="Configure pg_textsearch">
