...
In [{C.CONSOLE}](https://console.cloud.tigerdata.com/dashboard/services) open an [SQL editor](/get-started/run-queries-from-console). You can also connect to your {C.SERVICE_SHORT} using [psql](/integrate/psql#connect-to-your-service).
