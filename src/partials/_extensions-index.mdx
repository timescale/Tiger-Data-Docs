...
|---------------------------------------------|--------------------------------------------|-----------------------------------------------------------------------|
| [pgai](https://github.com/timescale/pgai)                                | Helper functions for AI workflows          | For [AI-focused](/get-started) {C.SERVICE_SHORT}s                            |
| [pg_textsearch](../tiger-cloud-extensions/pg-textsearch)              | [BM25](https://en.wikipedia.org/wiki/Okapi_BM25)-based full-text search   | Production-ready (v1.0.0) |
