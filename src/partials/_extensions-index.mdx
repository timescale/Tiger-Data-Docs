...
| Extension                                        | Description                                                             | Enabled by default |
|--------------------------------------------------|-------------------------------------------------------------------------|--------------------|
| [address_standardizer](https://postgis.net/docs/standardize_address.html) | Parse an address into its elements, for geocoding normalization        | ❌ |
| [address_standardizer_data_us](https://postgis.net/docs/standardize_address.html) | US dataset for address_standardizer                            | ❌ |
| [h3](https://pgxn.org/dist/h3/)                                         | H3 bindings for {C.PG}                                                     | ❌ |
| [h3_postgis](https://pgxn.org/dist/h3/)                                 | H3 integration with PostGIS                                             | ❌ |
...
| [pg_uuidv7](https://github.com/fboulnois/pg_uuidv7)                        | Generate UUIDv7 values                                                  | ❌ |
| [pgrouting](https://pgrouting.org/)                           | Geospatial routing functionality                                        | ❌ |
| [pgtap](https://pgtap.org/)                                               | Unit testing for {C.PG}                                                    | ❌ |
...
| [roaringbitmap](https://github.com/ChenHuajun/pg_roaringbitmap)            | Roaring bitmap data type and functions                                  | ❌ |
