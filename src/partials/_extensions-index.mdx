...
|---------------------------------------------|--------------------------------------------|-----------------------------------------------------------------------|
| [pgai](/ai)                                | Helper functions for AI workflows          | For [AI-focused](/get-started) {C.SERVICE_SHORT}s                            |
| [pg_textsearch](./pg-textsearch)              | [BM25](https://en.wikipedia.org/wiki/Okapi_BM25)-based full-text search   | Currently early access. For development and staging environments only |
