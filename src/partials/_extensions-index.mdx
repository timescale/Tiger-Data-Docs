...
The following {C.PG} extensions are installed with each {C.SERVICE_LONG}:
...
|---------------------------------------------|--------------------------------------------|-----------------------------------------------------------------------|
| [pgai](/reference/pgai)                                | Helper functions for AI workflows          | For [AI-focused](/get-started) {C.SERVICE_SHORT}s                            |
| [pg_textsearch](/deploy/tiger-cloud/tiger-cloud-aws/tiger-cloud-extensions/pg-textsearch)              | [BM25](https://en.wikipedia.org/wiki/Okapi_BM25)-based full-text search   | Production-ready (v1.0.0) |
| [pgvector](https://github.com/pgvector/pgvector)                        | Vector similarity search for {C.PG}           | For [AI-focused](/get-started) {C.SERVICE_SHORT}s                            |
| [pgvectorscale](https://github.com/timescale/pgvectorscale)              | Advanced indexing for vector data          | For [AI-focused](/get-started) {C.SERVICE_SHORT}s                            |
| [timescaledb_toolkit](https://github.com/timescale/timescaledb-toolkit)  | TimescaleDB Toolkit                        | For [Real-time analytics](/get-started) {C.SERVICE_SHORT}s                   |
| [timescaledb](https://github.com/timescale/timescaledb)                  | TimescaleDB                                | For all {C.SERVICE_SHORT}s                                               |
...
| [old_snapshot](https://www.postgresql.org/docs/16/oldsnapshot.html)             | Utilities in support of `old_snapshot_threshold`                       | -                       |
| [pgcrypto](/deploy/tiger-cloud/tiger-cloud-aws/tiger-cloud-extensions/pgcrypto)                     | Cryptographic functions                                                | -                       |
...
| [pg_stat_statements](https://www.postgresql.org/docs/current/pgstatstatements.html) | Track execution statistics of all SQL statements executed              | For all {C.SERVICE_SHORT}s |
...
| [plpgsql](https://www.postgresql.org/docs/current/plpgsql.html)                       | SQL procedural language                                                | For all {C.SERVICE_SHORT}s |
| [postgres_fdw](https://www.postgresql.org/docs/current/postgres-fdw.html)             | Foreign data wrappers                                                  | For all {C.SERVICE_SHORT}s |
...
| [pg_cron](https://github.com/citusdata/pg_cron)                                | SQL commands that you can schedule and run directly inside the database | [Contact us](mailto:support@tigerdata.com) to enable |
...
| [postgis](/deploy/tiger-cloud/tiger-cloud-aws/tiger-cloud-extensions/postgis)                               | PostGIS geometry and geography spatial types and functions              | -                                                    |
