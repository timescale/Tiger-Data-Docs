...
There is no command that lists your {C.PROJECT_SHORT}s. Find the ID in [{C.CONSOLE_LONG}](/integrate/find-connection-details#find-your-project-and-service-id), or read it out of any {C.SERVICE_SHORT}'s connection string.
