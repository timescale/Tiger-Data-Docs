...
11. expect label `Quick connect`
12. dismiss
13. click tab `Change configuration`
14. choose an unselected option
15. click `Change configuration`
16. confirm `Change config`
17. click `Overview`
18. expect url /overview
