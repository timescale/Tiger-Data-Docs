...
To change your HA replica strategy, click the `Change configuration` tab, choose a strategy, and click `Change configuration`.

To get the connection information for the HA replica, open it in one of these ways, then select `Read endpoint` in `Role`:

- In `Active configuration`, click the link icon next to the replica.
- In `Overview`, click `More details` next to `Connection info`.

<TestPlan>

1. fork the service
2. select the service
3. click `Operations` > `High availability`
4. expect url /operations/high-availability
5. choose an unselected option
6. click `Change configuration`
7. click `Change config`
8. expect label `Enabled`
9. click tab `Active configuration`
10. [resolve: link icon next to the replica]
11. select another option in `Role`
12. expect label `Running reads on an HA replica?`
13. dismiss
14. click `Overview`
15. expect url /overview
16. click `More details` in `Connection info`
17. select another option in `Role`
18. expect label `Read endpoint`
19. dismiss
20. click `Operations` > `High availability`
21. click tab `Change configuration`
22. choose an unselected option
23. click `Change configuration`
24. confirm `Change config`
25. expect label `No replica`
