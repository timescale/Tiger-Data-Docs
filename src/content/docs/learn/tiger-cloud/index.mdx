...
<RelatedContentCards>
  <RelatedContentCard title="What it adds" description={`What ${C.CLOUD_LONG} adds over ${C.SELF_LONG} Community Edition`} href="/learn/tiger-cloud/cloud-exclusive-features" />
