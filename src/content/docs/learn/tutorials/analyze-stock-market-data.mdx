...
If you would rather build candlestick charts on a live dashboard, see [Visualize financial tick data with Grafana](/learn/tutorials/analyze-financial-tick-data), which uses a crypto dataset.
