...
If you would rather visualize a taxi-style dataset on a live dashboard, see [Visualize transport and geospatial data with Grafana](/learn/tutorials/analyze-transport-data).
