...
The [`time_bucket`](/reference/timescaledb/hyperfunctions/time-series-utilities/time_bucket) function enables you to aggregate data in a [hypertable](/build/data-management/understand-hypertables) into buckets of time. For example, 5 minutes, 1 hour, or 3 days.
