...
import imgTimeBucket from "../../../../../assets/images/learn/fundamentals/time-bucket.webp";
import imgTimeBucketOrigin from "../../../../../assets/images/learn/fundamentals/time-bucket-origin.webp";
...
<Image src={imgTimeBucket} alt="Diagram showing time_bucket aggregating data into daily buckets and calculating the daily sum" />
...
<Image src={imgTimeBucketOrigin} alt="Diagram showing how time bucket boundaries are calculated from the origin timestamp" />
...
- [Use {C.TIME_BUCKET}s](/learn/data-management/time-buckets/use-time-buckets): SQL examples
