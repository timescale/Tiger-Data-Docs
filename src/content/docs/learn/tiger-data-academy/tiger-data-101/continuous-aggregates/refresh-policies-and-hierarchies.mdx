...
<div style="background: linear-gradient(135deg, #4f6bed 0%, #667eea 100%); border-radius: 8px; padding: 20px; margin: 28px 0; color: white; box-shadow: 0 4px 12px rgba(79, 107, 237, 0.15);">
  ...
  <a href="/learn/tiger-data-academy/tiger-data-101/continuous-aggregates/knowledge-check" style="color: #e0e7ff; text-decoration: none; font-weight: 500; display: block; font-size: 15px;">
    **Knowledge Check** — Test your understanding of Continuous Aggregates.
  </a>
</div>
