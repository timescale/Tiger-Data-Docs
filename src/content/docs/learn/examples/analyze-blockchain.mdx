...
1.  Connect to your Tiger Cloud service In [Tiger Console](https://console.cloud.timescale.com/dashboard/services) open an [SQL editor](/deploy/tiger-cloud/get-started/run-queries-from-console). The in-Console editors display the query speed. You can also connect to your service using [psql](/integrate/psql#connect-to-your-service).
...
3.  In Terminal, navigate to the folder where you unzipped the Bitcoin transactions, then connect to your service using [psql](/integrate/psql#connect-to-your-service).
