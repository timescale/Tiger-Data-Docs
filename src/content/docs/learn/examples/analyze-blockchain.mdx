...
In this section, you use [{C.TIMESCALE_DB} hyperfunctions](/reference/hyperfunctions) to construct
...
You can use [{C.CAGG}s](/build/continuous-aggregates/understand-continuous-aggregates) to simplify and speed up your
