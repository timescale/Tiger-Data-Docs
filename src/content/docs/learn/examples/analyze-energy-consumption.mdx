...
on [data in the {C.COLUMNSTORE}](/get-started/key-features-timescale)
and [rarely accessed data in tiered storage](/deploy/tiger-cloud/storage/query-tiered-data). You can even
