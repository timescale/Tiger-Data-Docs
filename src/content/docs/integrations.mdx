...
![tigerlake](https://assets.timescale.com/docs/icons/apache-iceberg-logo.png)[{C.LAKE}](/integrate/connectors/destination/tigerlake)
...
![code](https://assets.timescale.com/docs/icons/code-icon.svg)[Start coding with Tiger Data](/integrate/code)
...
![kafka](https://assets.timescale.com/docs/icons/kafka-logo.png)[Apache Kafka](/integrate/data-ingestion-streaming/apache-kafka)
...
![emqx](https://assets.timescale.com/docs/icons/emqx-logo.png)[EMQX](/integrate/data-ingestion-streaming/emqx)

Stream MQTT messages from an EMQX broker into Tiger Cloud
...
![highbyte](https://assets.timescale.com/docs/icons/highbyte-logo.svg)[HighByte](/integrate/data-ingestion-streaming/highbyte)
...
![parseable](https://www.parseable.com/parseable_icon.svg)[Parseable ↗](https://www.parseable.com/docs/ingest-data/databases/postgresql)

Collect and analyze logs, metrics and traces with an open-source unified observability platform
