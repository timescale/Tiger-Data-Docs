...
A Tiger Cloud service is a Postgres database instance extended by Tiger Data with custom capabilities. This means that any third-party solution that you can integrate with Postgres, you can also integrate with Tiger Cloud. See [the full list](https://slashdot.org/software/p/PostgreSQL/integrations/) of Postgres integrations.Some of the most in-demand integrations are listed below.
...
![tigerlake](https://assets.timescale.com/docs/icons/apache-iceberg-logo.png)[Tiger Lake](/integrations/connectors/destination/tigerlake)

Synchronize data to external destinations like data lakes

![postgres](https://assets.timescale.com/docs/icons/postgresql-logo.png)[Sync from Postgres](/integrations/connectors/source/sync-from-postgres)

Ingest data from external Postgres databases

![s3](https://assets.timescale.com/docs/icons/aws-logo.png)[Sync from S3](/integrations/connectors/source/sync-from-s3)

Ingest data from Amazon S3 buckets

![kafka](https://assets.timescale.com/docs/icons/kafka-logo.png)[Sync from Kafka](/integrations/connectors/source/sync-from-kafka)
...
![code](https://assets.timescale.com/docs/icons/code-icon.svg)[Start coding with Tiger Data](/integrations/code/start-coding-with-tigerdata)
...
![power-bi](https://assets.timescale.com/docs/icons/power-bi-logo.png)[Power BI](/integrations/bi-vizualization/power-bi)
...
![tableau](https://assets.timescale.com/docs/icons/tableau-logo.png)[Tableau](/integrations/bi-vizualization/tableau)
...
![kubernetes](https://assets.timescale.com/docs/icons/kubernets-logo.png)[Kubernetes](/integrations/configuration-deployment/kubernetes)
...
![terraform](https://assets.timescale.com/docs/icons/terraform-logo.png)[Terraform](/integrations/configuration-deployment/terraform)
...
![sagemaker](https://assets.timescale.com/docs/icons/amazon-sagemaker-logo.png)[Amazon SageMaker](/integrations/data-engineering-etl/amazon-sagemaker)

Build, train, and deploy ML models with Amazon SageMaker

![airflow](https://assets.timescale.com/docs/icons/airflow-logo.png)[Apache Airflow](/integrations/data-engineering-etl/apache-airflow)
...
![kafka](https://assets.timescale.com/docs/icons/kafka-logo.png)[Apache Kafka](/integrations/data-engineering-etl/apache-kafka)

Stream high-performance data pipelines and analytics

![lambda](https://assets.timescale.com/docs/icons/lambda-logo.png)[AWS Lambda](/integrations/data-engineering-etl/aws-lambda)
...
![debezium](https://assets.timescale.com/docs/icons/debezium-logo.png)[Debezium](/integrations/data-engineering-etl/debezium)

Capture and stream real-time database changes

![decodable](https://assets.timescale.com/docs/icons/decodable-logo.png)[Decodable](/integrations/data-engineering-etl/decodable)
...
![supabase](https://assets.timescale.com/docs/icons/supabase-logo.svg)[Supabase](/integrations/data-engineering-etl/supabase)
...
![fivetran](https://assets.timescale.com/docs/icons/fivetran-logo.png)[Fivetran](/integrations/data-ingestion-streaming/fivetran)
...
![cloudwatch](https://assets.timescale.com/docs/icons/cloudwatch-logo.png)[Amazon CloudWatch](/integrations/observability-alerting/cloudwatch)
...
![datadog](https://assets.timescale.com/docs/icons/datadog-logo.png)[Datadog](/integrations/observability-alerting/datadog)

Comprehensive monitoring and analytics platform

![grafana](https://assets.timescale.com/docs/icons/grafana-logo.png)[Grafana](/integrations/observability-alerting/grafana)
...
![prometheus](https://assets.timescale.com/docs/icons/prometheus-logo.png)[Prometheus](/integrations/observability-alerting/prometheus)
...
![telegraf](https://assets.timescale.com/docs/icons/Influx-telegraf.svg)[Telegraf](/integrations/observability-alerting/telegraf)
...
![azure-data-studio](https://assets.timescale.com/docs/icons/azure-data-studio-logo.png)[Azure Data Studio](/integrations/query-administration/azure-data-studio)

Query, manage, and develop Postgres databases

![dbeaver](https://assets.timescale.com/docs/icons/dbeaver-logo.png)[DBeaver](/integrations/query-administration/dbeaver)
...
![pgadmin](https://assets.timescale.com/docs/icons/pgadmin-logo.png)[pgAdmin](/integrations/query-administration/pgadmin)

Manage and administer Postgres databases through a graphical interface

![postgresql](https://assets.timescale.com/docs/icons/postgresql-logo.png)[Postgres](/integrations/query-administration/postgresql)

Connect using native Postgres tools and protocols
...
![psql](https://assets.timescale.com/docs/icons/psql-logo.png)[psql](/integrations/query-administration/psql)

Command-line interface for Postgres

![qlik](https://assets.timescale.com/docs/icons/qlik-logo.png)[Qlik Replicate ↗](https://help.qlik.com/en-US/replicate/November2024/Content/Replicate/Main/PostgreSQL/postgresql.htm)

Move and synchronize data across multiple database platforms

![qstudio](https://assets.timescale.com/docs/icons/qstudio-logo.png)[qStudio](/integrations/query-administration/qstudio)
...
![aws](https://assets.timescale.com/docs/icons/aws-logo.png)[Amazon Web Services](/integrations/secure-connectivity/aws)

Connect your AWS infrastructure to Tiger Cloud

![data-center](https://assets.timescale.com/docs/icons/corporate-data-center-logo.png)[Corporate data center](/integrations/secure-connectivity/corporate-data-center)

Connect your on-premise data center to Tiger Cloud

![google-cloud](https://assets.timescale.com/docs/icons/google-cloud-logo.png)[Google Cloud](/integrations/secure-connectivity/google-cloud)

Connect your Google Cloud infrastructure to Tiger Cloud

![azure](https://assets.timescale.com/docs/icons/azure-logo.png)[Microsoft Azure](/integrations/secure-connectivity/microsoft-azure)
