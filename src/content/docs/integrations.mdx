...
![postgres](https://assets.timescale.com/docs/icons/postgresql-logo.png)[Sync from Postgres](/integrate/connectors/source/sync-from-postgres)
...
![postgresql](https://assets.timescale.com/docs/icons/postgresql-logo.png)[Postgres](/integrate/query-administration/postgresql)
