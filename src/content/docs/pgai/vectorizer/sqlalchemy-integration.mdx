...
Note if you work with alembics autogenerate functionality for migrations, also check the [Alembic integration guide](alembic-integration).
...
We recommend adding this to a migration script and run it via alembic (see our [alembic integration docs](alembic-integration) for more details).
