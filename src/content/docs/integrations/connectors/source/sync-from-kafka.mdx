...
2.  **Create API keys**
    ...
    7.  Use the same procedure to add the following keys:
        ...
        -   ACL 3: Consumer group access
            ...
            -   `Consumer group ID`: `tigerdata-kafka/<tiger_cloud_project_id>`. See [Find your connection details](/integrations/find-connection-details) for where to find your project ID
