...
2.  **Connect to your Tiger Cloud service**
    ...
    3.  Use your [connection details](/integrations/find-connection-details) to configure the data source.
...
1.  **Connect Power BI to your Tiger Cloud service**
    ...
    4.  Use your [connection details](/integrations/find-connection-details) to enter your `User Name` and `Password`, then click `Connect`.
