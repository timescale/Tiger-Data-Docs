...
- **Downgrade**: reinstall an older version of {C.TIMESCALE_DB} on your {C.SERVICE_LONG} that matches the source database:
    ...
    Connect to your {C.SERVICE_LONG} and check the versions of {C.TIMESCALE_DB} available:
    ...
    If an available {C.TIMESCALE_DB} release matches your source database, uninstall and reinstall:
