...
4.  **Check for irregular data** To determine if the freezer has been out of temperature range for more than 15 minutes at a time, use a [time-weighted average](/api-reference/timescaledb/hyperfunctions/time-weighted-calculations/time_weight) in a window function:
