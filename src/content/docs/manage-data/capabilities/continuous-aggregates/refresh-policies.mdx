...
-   If you set `end_offset` within the current time bucket, this bucket is excluded from materialization. This is done for the following reasons:
    ...
    To include the latest raw data in queries, enable [real-time aggregation](/manage-data/capabilities/continuous-aggregates/real-time-aggregates).
