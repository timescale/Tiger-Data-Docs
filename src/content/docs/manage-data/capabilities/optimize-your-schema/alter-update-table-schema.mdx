...
For more information about Postgres `ALTER TABLE` operations, see the [Postgres `ALTER TABLE` documentation](https://www.postgresql.org/docs/current/sql-altertable.html).