...
import imgUuidv7Structure from "../../../../../assets/images/reference/timescaledb/uuidv7-structure.svg?url";

<SinceRelease version="2.23.0" product="tsdb" />

Extract the version number from a UUID object:

<img src={imgUuidv7Structure} alt="UUIDv7 structure: timestamp, version, random bits" />
