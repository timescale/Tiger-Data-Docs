...
- [`to_uuidv7()`][to_uuidv7]: create a version 7 UUID from a {C.PG} timestamp
- [`to_uuidv7_boundary()`][to_uuidv7_boundary]: create a version 7 "boundary" UUID from a {C.PG} timestamp
- [`uuid_timestamp()`][uuid_timestamp]: extract a {C.PG} timestamp from a version 7 UUID
- [`uuid_timestamp_micros()`][uuid_timestamp_micros]: extract a {C.PG} timestamp with microsecond precision from a
  version 7 UUID
- [`uuid_version()`][uuid_version]: extract the version of a UUID

[generate_uuidv7]: /reference/timescaledb/uuid-functions/generate_uuidv7

[to_uuidv7]: /reference/timescaledb/uuid-functions/to_uuidv7

[to_uuidv7_boundary]: /reference/timescaledb/uuid-functions/to_uuidv7_boundary

[uuid_timestamp]: /reference/timescaledb/uuid-functions/uuid_timestamp

[uuid_timestamp_micros]: /reference/timescaledb/uuid-functions/uuid_timestamp_micros

[uuid_version]: /reference/timescaledb/uuid-functions/uuid_version
