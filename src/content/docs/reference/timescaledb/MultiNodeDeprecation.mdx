---
title: MultiNodeDeprecation
description: Multi-node support has been deprecated.
---
...
TimescaleDB 2.13 is the last version that will include multi-node support. Multi-node support in 2.13 is available for {C.PG} 13, 14 and 15.
