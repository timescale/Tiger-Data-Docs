...
For more information about creating a data retention policy, see the [data retention section](/build/data-management/data-retention/create-a-retention-policy).
...
- [`add_retention_policy()`](/reference/timescaledb/data-retention/add_retention_policy): create a policy to drop {C.CHUNK}s older than a given interval
- [`remove_retention_policy()`](/reference/timescaledb/data-retention/remove_retention_policy): remove a policy to drop {C.CHUNK}s of a particular {C.HYPERTABLE}
