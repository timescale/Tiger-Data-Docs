...
<SinceRelease mode="deprecated" version="2.0.0" product="tsdb" /><br />
...
- [timescaledb\_information.hypertable\_compression\_settings](/reference/timescaledb/informational-views/hypertable_compression_settings)
- [timescaledb\_information.chunk\_compression\_settings](/reference/timescaledb/informational-views/chunk_compression_settings).

Get information about compression-related settings for {C.HYPERTABLE}s.
