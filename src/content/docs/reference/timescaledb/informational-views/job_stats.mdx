...
other automation policies. (See [policies](/reference/timescaledb/jobs-automation)).
...
Get job success/failure information for a specific {C.HYPERTABLE}.
...
Get information about {C.CAGG} policy related statistics
