...
| `sqlerrcode` | TEXT | The error code associated with this error, if any. See the [official Postgres documentation][official-postgres-documentation] for a full list of error codes |
...
[official-postgres-documentation]: https://www.postgresql.org/docs/current/errcodes-appendix.html

[tsdb-2.12.0]: https://github.com/timescale/timescaledb/releases/tag/2.12.0
