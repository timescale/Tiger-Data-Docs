...
| `sqlerrcode` | TEXT | The error code associated with this error, if any. See the [official {C.PG} documentation][official-postgres-documentation] for a full list of error codes |
