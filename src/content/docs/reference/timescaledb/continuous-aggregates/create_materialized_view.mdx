...
[{C.CAGG} how-to guides][cagg-how-tos].
...
[GUC parameter][gucs]. This enables {C.CAGG}
...
For more settings for {C.CAGG}s, see [timescaledb\_information.continuous\_aggregates][info-views].
...
For standard `CREATE MATERIALIZED VIEW` return behavior, see the [{C.PG} CREATE MATERIALIZED VIEW documentation][postgres-create-matview].
...
[info-views]: /reference/timescaledb/informational-views/continuous_aggregates
...
[refresh-cagg]: /reference/timescaledb/continuous-aggregates/refresh_continuous_aggregate
