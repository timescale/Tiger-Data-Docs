---
title: TimescaleDB Examples
description: >-
  This directory contains complete, standalone examples to help you get started
  with TimescaleDB using real-world use cases. Each example includes sample data
  and analytical queries to showcase TimescaleDB's capabilities.
---
...
We use port **6543** (mapped to container port 5432) to avoid conflicts if you have other PostgreSQL instances running on the standard port 5432.
</Callout>
