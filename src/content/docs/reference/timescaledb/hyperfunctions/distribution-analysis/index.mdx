...
keywords: [distribution analysis, distribution analysis overview, hyperfunctions, timescaledb]
---
...
Get a fast approximate count of rows in a {C.HYPERTABLE} without a full table scan:
...
- [`histogram()`](/reference/timescaledb/hyperfunctions/distribution-analysis/histogram): partition a dataset into buckets and get the number of counts in each bucket

### Approximate aggregation

- [`approximate_row_count()`](/reference/timescaledb/hyperfunctions/distribution-analysis/approximate_row_count): estimate the number of rows in a table using catalog statistics
