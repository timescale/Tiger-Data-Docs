...
keywords: [gapfilling overview, hyperfunctions, time bucket gapfill, timescaledb]
sidebar:
  label: Overview
---
...
`time_bucket_gapfill` works similarly to [`time_bucket`](/reference/timescaledb/hyperfunctions/time-series-utilities/time_bucket), but adds
...
- [`time_bucket_gapfill()`](/reference/timescaledb/hyperfunctions/time_bucket_gapfill/time_bucket_gapfill): bucket rows by time interval while filling gaps in data

### Interpolators

- [`locf()`](/reference/timescaledb/hyperfunctions/time_bucket_gapfill/locf): fill in missing values by carrying the last observed value forward
- [`interpolate()`](/reference/timescaledb/hyperfunctions/time_bucket_gapfill/interpolate): fill in missing values by linear interpolation
