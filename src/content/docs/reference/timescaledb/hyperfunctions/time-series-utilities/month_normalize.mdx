...
<TagIcon iconType="duotone" /> Since [1.16.0][tsdb-1.16.0]
...
|-|-|-|
| `month_normalize` | DOUBLE PRECISION | The normalized metric value, adjusted to a standard 30.4375-day month (365.25/12). |
