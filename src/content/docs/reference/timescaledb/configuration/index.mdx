...
To interpret the license value and see which features each edition includes, see [Compare {C.TIMESCALE_DB} editions](/get-started/choose-your-path/timescaledb-editions#check-your-installed-edition).
