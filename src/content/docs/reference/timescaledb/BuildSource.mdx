---
title: 'Find the latest release and checkout, e.g. for 2.15.0:'
description: If you are building from source for non-development purposes
---
...
- A standard {C.PG} 15, 16, or 17 installation with development
environment (header files) (e.g., `postgresql-server-dev-17` package
for Linux, {C.PG}.app for MacOS)
...
Note, if you have multiple versions of {C.PG} installed you can specify the path to `pg_config`
...
- A standard [{C.PG} 15, 16, or 17 64-bit installation](https://www.enterprisedb.com/downloads/postgres-postgresql-downloads#windows)
- OpenSSL for Windows
