...
<SinceRelease mode="deprecated" version="2.13.0" product="tsdb">. Use [add_dimension()][add-dimension].</SinceRelease><br />
...
[create_hypertable]: /reference/timescaledb/hypertables/create_hypertable_old
