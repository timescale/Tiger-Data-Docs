...
Replace a standard {C.PG} relational table with a [{C.HYPERTABLE}](/build/data-management/understand-hypertables) that is partitioned on a single
...
|`dimension`| [DIMENSION\_INFO](/reference/timescaledb/hypertables/create_hypertable/#dimension-info) | -       | ✔ | To create a `_timescaledb_internal.dimension_info` instance to partition a hypertable, you call  [`by_range`](/reference/timescaledb/hypertables/create_hypertable/#by_range) and [`by_hash`](/reference/timescaledb/hypertables/create_hypertable/#by_hash).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
