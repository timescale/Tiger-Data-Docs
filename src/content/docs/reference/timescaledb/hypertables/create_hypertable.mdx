...
[create-hypertable-old]: /api-reference/timescaledb/hypertables/create_hypertable_old
...
[sample-uuidv7]: /api-reference/timescaledb/hypertables/create_hypertable/#time-partition-a-hypertable-using-uuidv7
