...
this {C.HYPERTABLE} is added to the columnstore using the [convert\_to\_columnstore][convert_to_columnstore] function.
...
A [convert\_to\_rowstore][convert_to_rowstore] invocation on a compressed {C.CHUNK} resets its entries
