...
<ArchiveIcon iconType="duotone" /> Old API [v2.13.0][tsdb-2.13.0]. Use [`create_hypertable`][api-create-hypertable]. <TagIcon iconType="duotone" /> Since [1.0.0][tsdb-1.0.0]
...
[tsdb-1.0.0]: https://github.com/timescale/timescaledb/releases/tag/1.0.0

[tsdb-2.13.0]: https://github.com/timescale/timescaledb/releases/tag/2.13.0
