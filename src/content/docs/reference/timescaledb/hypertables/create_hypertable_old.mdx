...
<SinceRelease mode="deprecated" version="2.13.0" product="tsdb">. Use the [new interface](/reference/timescaledb/hypertables/create_hypertable).</SinceRelease><br />
...
see the [hypertable documentation](/build/data-management/understand-hypertables).
...
[{C.PG} documentation](https://www.postgresql.org/docs/current/sql-lock.html)
for the syntax.
