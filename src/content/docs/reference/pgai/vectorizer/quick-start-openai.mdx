---
title: Vectorizer quick start with OpenAI
description: >-
  This page shows you how to create a vectorizer in a self-hosted Postgres
  instance, then use
---
...
This page shows you how to create a vectorizer in a self-hosted {C.PG} instance, then use 
...
| {C.PG} is a powerful, open source object-relational database system...    |  0.815629243850708 |
