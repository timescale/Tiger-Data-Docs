...
running. You can do this by setting [scheduling =>ai.scheduling_none()](/pgai/vectorizer/api-reference.md#scheduling-configuration)
...
1. **Run the vectorizer worker**
    ...
    After you [define a vectorizer in your database](/pgai/vectorizer/overview.md#define-a-vectorizer), you run
...
1. **Run the vectorizer worker**
    ...
    After you [define a vectorizer in your database](/pgai/vectorizer/overview.md#define-a-vectorizer), you run a vectorizer worker to generate and update your embeddings.
