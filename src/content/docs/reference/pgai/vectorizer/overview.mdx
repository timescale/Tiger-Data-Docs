...
**Tip**: You can use the `ai.ollama_embed` function in our [{C.PG} extension](/projects/extension/README) to generate an embedding for a user-provided query right inside the database.
