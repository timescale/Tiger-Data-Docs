...
description: >-
  Alembic is a database migration tool that allows you to manage your database
  schema. This document describes how to use Alembic to manage your vectorizer
  definitions, since those should be consider...
---
# Alembic integration
...
The `create_vectorizer` operation supports all configuration options available in the [SQL API](/reference/pgai/vectorizer/api-reference).
