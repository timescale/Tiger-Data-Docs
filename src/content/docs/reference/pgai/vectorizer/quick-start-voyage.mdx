---
title: Vectorizer quick start with VoyageAI
description: >-
  This page shows you how to create a vectorizer and run a semantic search on
  the automatically embedded data on a self-hosted Postgres instance.
---
...
This page shows you how to create a vectorizer and run a semantic search on the automatically embedded data on a self-hosted {C.PG} instance.
...
4. **Create a vectorizer for `blog`**
    ...
    **Quantization Options:**
    ...
    Note: Quantized embeddings are automatically converted to float for storage in {C.PG}, so you get bandwidth savings but not storage savings.
...
| {C.PG} is a powerful, open source object-relational database system... | 0.7789760644464416 |
