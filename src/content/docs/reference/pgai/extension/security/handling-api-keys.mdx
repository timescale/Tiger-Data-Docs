...
1. Navigate to the "AI Model API Keys" tab under "Project settings"
   ...
   ![Timescale Cloud project settings](/pgai/extension/images/timescale_project_settings.png)

1. Add a new AI Model API key, providing the name and API key

   ![Timescale Cloud new AI model API key](/pgai/extension/images/timescale_new_ai_model_api_key.png)
