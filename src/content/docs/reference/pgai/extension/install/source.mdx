...
not found`, download and install the latest version of [Python3][python3].
   ...
   - **PL/Python**: follow [How to install {C.PG} 16 with plpython3u: Recipes for macOS, Ubuntu, Debian, CentOS, Docker][pgai-plpython].
   ...
   - **pgvector**: follow the [install instructions][pgvector-install] from the official repository. This extension is automatically added to your {C.PG} database when you install the pgai extension.
