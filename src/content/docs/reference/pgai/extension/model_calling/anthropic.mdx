...
The [extract_entities.sql](https://github.com/timescale/pgai/tree/main/examples/extract_entities.sql) is wrapping the
function.
...
```
Through the same mechanism, the [summarize_article.sql](https://github.com/timescale/pgai/tree/main/examples/summarize_article.sql)
