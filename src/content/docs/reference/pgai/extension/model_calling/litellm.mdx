...
- [Use LiteLLM for vector embeddings](#embed)
...
![Azure AI Foundry console example](https://raw.githubusercontent.com/timescale/pgai/main/docs/extension/images/azure_openai.png)
...
<Callout variant="note">
`VERTEX_CREDENTIALS` should contain the path to a file containing the API key; the database process must have access to this file in order to load the credentials.
</Callout>
