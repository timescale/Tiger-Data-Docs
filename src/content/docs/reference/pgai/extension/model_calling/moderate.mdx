...
title: Moderate
description: >-
  Let's say you want to moderate comments using OpenAI. You can do it in two
  ways:
---
# Moderate
...
You can get the full example in the [trigger_moderate.sql](https://github.com/timescale/pgai/tree/main/examples/trigger_moderate.sql) file.
...
You can get the full example in the [bg_worker_moderate.sql](https://github.com/timescale/pgai/tree/main/examples/bg_worker_moderate.sql).
