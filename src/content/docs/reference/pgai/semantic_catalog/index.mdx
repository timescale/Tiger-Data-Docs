...
- [I want to create a semantic catalog for my database.](quickstart-your-data)
- [I want a walkthrough of capabilities on demo data.](quickstart-demo-data)
- Check out the [CLI reference.](cli)
