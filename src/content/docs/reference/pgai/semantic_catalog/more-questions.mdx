...
| 17 | easy | What is the most common aircraft model used by {C.PG} Air? |
...
| 52 | hard | How many passengers have flown with {C.PG} Air more than 5 times but are not frequent flyer members? |
...
| 81 | easy | What is the average age of all passengers who have booked flights with {C.PG} Air? |
