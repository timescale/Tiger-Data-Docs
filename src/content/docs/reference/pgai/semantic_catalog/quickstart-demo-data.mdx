---
title: Quickstart with demo data
description: >-
  We are going to use an open source postgres database named "postgres air" to
...
Using these tools, you create a semantic catalog in another {C.PG} database, then import and embed the descriptions.
...
Here is a list of [more questions to try.](/reference/pgai/semantic_catalog/more-questions)
