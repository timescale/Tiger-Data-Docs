---
title: Quickstart with your data
description: >-
  This quickstart will help you get up and running with the semantic catalog on
  your own database.
---
...
* A {C.PG} connection string to the database you want to have an LLM build queries for
* (Optionally) a {C.PG} connection string to a second database to house the semantic catalog
