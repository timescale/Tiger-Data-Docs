...
keywords: [counters and gauges, counters and gauges overview, timescaledb toolkit]
---
...
- [`counter_agg()`](/reference/toolkit/counters-and-gauges/counter_agg): analyze monotonically increasing counter metrics

### Gauge aggregation

- [`gauge_agg()`](/reference/toolkit/counters-and-gauges/gauge_agg): analyze gauge metrics that can increase or decrease
