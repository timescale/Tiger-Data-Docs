...
keywords: [counter agg, counter_agg, counters and gauges, timescaledb toolkit]
---
...
[`rollup()`](/reference/toolkit/counters-and-gauges/counter_agg/rollup) before an accessor is applied.
