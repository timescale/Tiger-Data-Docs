...
keywords: [counters and gauges, delta, gauge agg, timescaledb toolkit]
---
...
| --- | --- | --- | --- | --- |
| `summary` | `GaugeSummary` | - | ✔ | A gauge aggregated created using [`gauge_agg`](/reference/toolkit/counters-and-gauges/gauge_agg/gauge_agg) |
