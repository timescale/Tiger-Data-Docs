...
keywords: [counters and gauges, gauge agg, gauge_agg, timescaledb toolkit]
---
...
[`rollup()`](/reference/toolkit/counters-and-gauges/gauge_agg/rollup) before an accessor is applied.
