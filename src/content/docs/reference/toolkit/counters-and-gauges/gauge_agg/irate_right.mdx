...
keywords: [counters and gauges, gauge agg, irate_right, timescaledb toolkit]
---
...
|--------|------|-------------|
| irate\_right | DOUBLE PRECISION | The instantaneous rate of change at the right, or latest, edge of the gauge aggregate |
