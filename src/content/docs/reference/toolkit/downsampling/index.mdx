...
keywords: [downsampling, downsampling overview, timescaledb toolkit]
---
...
- [`lttb()`](/reference/toolkit/downsampling/lttb): downsample using the Largest Triangle Three Buckets method
- [`gp_lttb()`](/reference/toolkit/downsampling/gp_lttb): downsample using LTTB while preserving gaps in data

### ASAP smoothing

- [`asap_smooth()`](/reference/toolkit/downsampling/asap_smooth): downsample using the ASAP smoothing algorithm
