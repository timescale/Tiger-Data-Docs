...
keywords: [compact state agg, interpolated_duration_in, state tracking, timescaledb toolkit]
---
...
Calculate the total duration in the given state. Unlike [`duration_in`](/reference/toolkit/state-tracking/compact_state_agg/duration_in), you can use this function across
...
|------|------|---------|----------|-------------|
| agg | CompactStateAgg | - | ✔ | A state aggregate created with [`compact_state_agg`](/reference/toolkit/state-tracking/compact_state_agg/compact_state_agg) |
