...
keywords: [compact state agg, into_values, state tracking, timescaledb toolkit]
---
...
|------|------|---------|----------|-------------|
| agg | CompactStateAgg | - | ✔ | A state aggregate created with [`compact_state_agg`](/reference/toolkit/state-tracking/compact_state_agg/compact_state_agg#arguments) |
