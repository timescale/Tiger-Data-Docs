...
<FlaskConicalIcon /> Early access <TagIcon iconType="duotone" /> Since [1.5.0][toolkit-1.5.0]
...
[interpolated_duration_in]: /reference/toolkit/state-tracking/compact_state_agg/interpolated_duration_in#arguments
