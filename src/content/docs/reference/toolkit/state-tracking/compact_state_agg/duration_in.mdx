...
keywords: [compact state agg, duration_in, state tracking, timescaledb toolkit]
---
...
across time bucket boundaries, use [`interpolated_duration_in`](/reference/toolkit/state-tracking/compact_state_agg/interpolated_duration_in#arguments).
