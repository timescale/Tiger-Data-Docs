...
keywords: [heartbeat agg, interpolated_downtime, state tracking, timescaledb toolkit]
---
...
|--------|------|-------------|
| interpolated\_downtime | INTERVAL | The sum of all the unhealthy ranges in the aggregate, excluding those covered by the last heartbeat of the previous interval. |
