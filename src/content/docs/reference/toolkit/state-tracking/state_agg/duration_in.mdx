...
keywords: [duration_in, state agg, state tracking, timescaledb toolkit]
---
...
bucket boundaries, use [`interpolated_duration_in`](/reference/toolkit/state-tracking/state_agg/interpolated_duration_in).
