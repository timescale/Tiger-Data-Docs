...
keywords: [interpolated_duration_in, state agg, state tracking, timescaledb toolkit]
---
...
Calculate the total duration in a given state. Unlike [`duration_in`](/reference/toolkit/state-tracking/state_agg/duration_in), you can use this function across
