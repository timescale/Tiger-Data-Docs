...
keywords: [state agg, state tracking, state_agg, timescaledb toolkit]
---
...
Aggregate state data into a state aggregate to track state transitions. Unlike [`compact_state_agg`](/reference/toolkit/state-tracking/compact_state_agg),
