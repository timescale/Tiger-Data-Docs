...
keywords: [into_values, state agg, state tracking, timescaledb toolkit]
---
...
|------|------|---------|----------|-------------|
| agg | StateAgg | - | ✔ | A state aggregate created with [`state_agg`](/reference/toolkit/state-tracking/state_agg/state_agg#arguments) |
