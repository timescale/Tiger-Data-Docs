...
keywords: [interpolated_state_periods, state agg, state tracking, timescaledb toolkit]
---
...
Unlike [`state_periods`](/reference/toolkit/state-tracking/state_agg/state_periods), you can use this function across multiple state aggregates that cover different
...
|------|------|---------|----------|-------------|
| agg | StateAgg | - | ✔ | A state aggregate created with [`state_agg`](/reference/toolkit/state-tracking/state_agg/state_agg) |
