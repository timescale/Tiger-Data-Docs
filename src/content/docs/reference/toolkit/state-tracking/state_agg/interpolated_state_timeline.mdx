...
keywords: [interpolated_state_timeline, state agg, state tracking, timescaledb toolkit]
---
...
Unlike [`state_timeline`](/reference/toolkit/state-tracking/state_agg/state_timeline), you can use this function across multiple state aggregates that cover
