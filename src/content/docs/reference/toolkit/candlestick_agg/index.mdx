...
keywords: [candlestick agg, financial analysis overview, timescaledb toolkit]
sidebar:
  label: Overview
---
...
[`candlestick_agg`](/reference/toolkit/candlestick_agg/candlestick_agg), it also includes the pseudo-aggregate
function [`candlestick`](/reference/toolkit/candlestick_agg/candlestick). `candlestick_agg` produces a candlestick aggregate from
...
You can use the [`candlestick`](/reference/toolkit/candlestick_agg/candlestick) function to transform the data
into a form that you'll be able pass to all of the accessors and
[`rollup`](/reference/toolkit/candlestick_agg/rollup) functions. To show that your data is preserved, this example
...
that you can then use other functions in this group, such as [`rollup`](/reference/toolkit/candlestick_agg/rollup)
and [`vwap`](/reference/toolkit/candlestick_agg/vwap).
...
- [`candlestick_agg()`](/reference/toolkit/candlestick_agg/candlestick_agg): aggregate tick data into an intermediate form for further calculation

### Pseudo-aggregate

- [`candlestick()`](/reference/toolkit/candlestick_agg/candlestick): transform pre-aggregated candlestick data into the correct form to use with
  candlestick\_agg functions

### Accessors

- [`open()`](/reference/toolkit/candlestick_agg/open): get the opening price from a candlestick aggregate
- [`open_time()`](/reference/toolkit/candlestick_agg/open_time): get the timestamp of the opening price from a candlestick aggregate
- [`high()`](/reference/toolkit/candlestick_agg/high): get the high price from a candlestick aggregate
- [`high_time()`](/reference/toolkit/candlestick_agg/high_time): get the timestamp of the high price from a candlestick aggregate
- [`low()`](/reference/toolkit/candlestick_agg/low): get the low price from a candlestick aggregate
- [`low_time()`](/reference/toolkit/candlestick_agg/low_time): get the timestamp of the low price from a candlestick aggregate
- [`close()`](/reference/toolkit/candlestick_agg/close): get the closing price from a candlestick aggregate
- [`close_time()`](/reference/toolkit/candlestick_agg/close_time): get the timestamp of the closing price from a candlestick aggregate
- [`volume()`](/reference/toolkit/candlestick_agg/volume): get the total volume from a candlestick aggregate
- [`vwap()`](/reference/toolkit/candlestick_agg/vwap): calculate the volume-weighted average price from a candlestick aggregate

### Rollup

- [`rollup()`](/reference/toolkit/candlestick_agg/rollup): roll up multiple candlestick aggregates
