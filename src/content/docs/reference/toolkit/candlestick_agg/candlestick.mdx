...
keywords: [candlestick, candlestick agg, timescaledb toolkit]
experimental: false
---
...
If you're starting with raw tick data rather than candlestick data, use [`candlestick_agg()`](/reference/toolkit/candlestick_agg/candlestick_agg) instead.
