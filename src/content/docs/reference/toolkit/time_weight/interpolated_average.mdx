...
keywords: [interpolated_average, time weight, timescaledb toolkit]
---
...
Similar to [`average`](/reference/toolkit/time_weight/average), but allows an accurate calculation across interval bounds when data has been bucketed
...
Equal to [`interpolated_integral`](/reference/toolkit/time_weight/interpolated_integral) divided by the elapsed time.
