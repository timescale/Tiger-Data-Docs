...
keywords: [average, time weight, timescaledb toolkit]
---
...
Calculate the time-weighted average. Equal to [`integral`](/reference/toolkit/time_weight/integral) divided by the elapsed time. Note that there is a
