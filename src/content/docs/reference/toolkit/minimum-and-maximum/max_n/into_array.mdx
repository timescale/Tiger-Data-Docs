...
keywords: [into_array, max n, minimum and maximum, timescaledb toolkit]
---
...
|--------|------|-------------|
| into\_array | BIGINT\[ ] \| DOUBLE PRECISION\[ ] \| TIMESTAMPTZ\[ ] | The highest values seen while creating this aggregate. |
