...
keywords: [minimum and maximum, minimum and maximum overview, timescaledb toolkit]
sidebar:
  label: Overview
---
...
- [`min_n()`](/reference/toolkit/minimum-and-maximum/min_n): Get the N smallest values from a column
- [`max_n()`](/reference/toolkit/minimum-and-maximum/max_n): Get the N largest values from a column
- [`min_n_by()`](/reference/toolkit/minimum-and-maximum/min_n_by): Get the N smallest values with accompanying data (like full rows)
- [`max_n_by()`](/reference/toolkit/minimum-and-maximum/max_n_by): Get the N largest values with accompanying data (like full rows)
...
- [`min_n_by()`](/reference/toolkit/minimum-and-maximum/min_n_by): get the N smallest values with accompanying data

### Maximum values with data

- [`max_n_by()`](/reference/toolkit/minimum-and-maximum/max_n_by): get the N largest values with accompanying data
