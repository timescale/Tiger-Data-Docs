...
keywords: [percentile approximation, tdigest, timescaledb toolkit]
---
...
Optionally, multiple such intermediate aggregate objects can be combined using [`rollup()`](/reference/toolkit/percentile-approximation/tdigest/rollup) before an accessor is applied.
