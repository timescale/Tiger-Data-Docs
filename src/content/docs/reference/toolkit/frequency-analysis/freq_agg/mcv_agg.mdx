...
This differs from [`freq_agg`][freq-agg] in that you can specify a target number of values to keep, rather than a frequency cutoff.
...
[estimated-skew]: /reference/toolkit/frequency-analysis/freq_agg#estimated-skew
