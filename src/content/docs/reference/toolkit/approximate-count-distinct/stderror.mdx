...
keywords: [approximate count distinct, stderror, timescaledb toolkit]
---
...
[relative errors section](/reference/toolkit/approximate-count-distinct#approximate-relative-errors).
