...
keywords: [statistical and regression analysis, statistical and regression analysis overview, timescaledb toolkit]
---

import * as C from "@constants";

Perform statistical analysis and linear regression on time-series data. These functions are similar to {C.PG}
...
- [`stats_agg() (one variable)`](/reference/toolkit/statistical-and-regression-analysis/stats_agg-one-variable): analyze statistical properties of a single variable

### Two-dimensional statistics and regression

- [`stats_agg() (two variables)`](/reference/toolkit/statistical-and-regression-analysis/stats_agg-two-variables): analyze statistical properties and linear regression of two
  variables
