...
These functions are similar to the [{C.PG} statistical aggregates][pg-stats-aggs], but they include more features and are easier to
...
[average_y_x]: /reference/toolkit/statistical-and-regression-analysis/stats_agg-two-variables/average_y_x
...
[kurtosis_y_x]: /reference/toolkit/statistical-and-regression-analysis/stats_agg-two-variables/kurtosis_y_x
...
[skewness_y_x]: /reference/toolkit/statistical-and-regression-analysis/stats_agg-two-variables/skewness_y_x

[slope]: /reference/toolkit/statistical-and-regression-analysis/stats_agg-two-variables/slope

[stats_agg]: /reference/toolkit/statistical-and-regression-analysis/stats_agg-two-variables/stats_agg

[stats_agg-1d]: /reference/toolkit/statistical-and-regression-analysis/stats_agg-one-variable

[stddev_y_x]: /reference/toolkit/statistical-and-regression-analysis/stats_agg-two-variables/stddev_y_x

[sum_y_x]: /reference/toolkit/statistical-and-regression-analysis/stats_agg-two-variables/sum_y_x

[toolkit-1.3.0]: https://github.com/timescale/timescaledb-toolkit/releases/tag/1.3.0

[two-step-aggregation]: #two-step-aggregation

[variance_y_x]: /reference/toolkit/statistical-and-regression-analysis/stats_agg-two-variables/variance_y_x
