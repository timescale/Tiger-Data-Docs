...
functions. These functions are similar to the [{C.PG} statistical aggregates][pg-stats-aggs], but they include more features and are
...
[stats_agg-2d]: /reference/toolkit/statistical-and-regression-analysis/stats_agg-two-variables
