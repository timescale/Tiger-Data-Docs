...
If you **want to contribute** to this extension, see how to [build pgvectorscale from source in a developer environment](./DEVELOPMENT) and our [testing guide](./TESTING).
...
1. Compile and install the extension
    ...
    You can also take a look at our [documentation for extension developers](./DEVELOPMENT) for more complete instructions.
