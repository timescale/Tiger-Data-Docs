...
> **Note**: Label values must be within the {C.PG} `smallint` range (-32768 to 32767). Using `smallint[]` for labels ensures that {C.PG}'s type system will automatically enforce these bounds.
>
