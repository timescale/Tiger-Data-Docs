...
[Create your first Tiger Cloud service in minutes](/deploy-and-operate/tiger-cloud/get-started/get-started-with-tiger-cloud)
...
[Install and configure TimescaleDB on your infrastructure](/manage-data/get-started/get-started-with-timescaledb)
...
[Move your self-hosted database to Tiger Cloud with minimal downtime](/manage-data/import-and-ingest/live-migration)

[Export your data from Tiger Cloud for self-hosted deployment](/deploy-and-operate/tiger-cloud/storage/manage-storage-tiers)
