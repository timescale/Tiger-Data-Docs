...
<CardGroup>
  <Card icon={Table} title="Hypertables" href="/build/data-management/understand-hypertables">
    {C.PG} tables optimized for time-series data with automatic partitioning by time. Scale to billions of rows with fast queries across time ranges.
  </Card>
