...
This tutorial uses a dataset that contains second-by-second trade data for the most-traded crypto-assets. You optimize this time-series data in a hypertable called `crypto_ticks`. You also create a separate table of asset symbols in a regular Postgres table named `crypto_assets`.
