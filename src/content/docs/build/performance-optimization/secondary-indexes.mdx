...
To improve query performance using indexes, see [About indexes](/build/performance-optimization/understand-database-schemas) and [Indexing data](/build/performance-optimization/indexing).
