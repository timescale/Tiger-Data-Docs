...
To modify the schema of an existing {C.HYPERTABLE}, you can use the `ALTER TABLE`
command. When you change the {C.HYPERTABLE} schema, the changes are also propagated
to each underlying {C.CHUNK}.
