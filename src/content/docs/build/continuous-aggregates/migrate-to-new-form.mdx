...
<Callout variant="note">
  This procedure applies to {C.TIMESCALE_DB} v2.24 and earlier. In v2.25, the old format [has been fully removed](https://github.com/timescale/timescaledb/blob/main/CHANGELOG.md#2250-2026-01-29). Upgrading to v2.25 is blocked while any {C.CAGG} still uses the old format. Migrate every old-format {C.CAGG} before you upgrade.
</Callout>
