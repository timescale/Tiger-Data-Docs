...
On {C.CLOUD_LONG}, use [tiered storage](/build/data-management/storage) which handles this by providing a [tiering policy API](/build/data-management/storage/manage-storage#automate-tiering-with-policies) to move data to low-cost object storage backed by Amazon S3 and Azure Blob storage.
</Callout>
