...
You can use {C.TIMESCALE_DB} for a variety of analytical queries. Some of these
queries are native {C.PG}, and some are additional functions provided by {C.TIMESCALE_DB} and {C.TOOLKIT_LONG}. This section contains the most common and useful analytic queries.
