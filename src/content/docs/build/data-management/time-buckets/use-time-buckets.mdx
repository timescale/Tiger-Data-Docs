...
The `time_bucket` function helps you group data in a [hypertable](/learn/fundamentals/your-first-hypertable) so you can
...
work, see the [about {C.TIME_BUCKET}s section](/build/data-management/time-buckets/about-time-buckets).
