...
The [`time_bucket`](/reference/timescaledb/hyperfunctions/time-series-utilities/time_bucket) function enables you to aggregate data in a [hypertable](/learn/fundamentals/your-first-hypertable) into buckets of time. For example, 5 minutes, 1 hour, or 3 days.
...
rollups as needed, or pre-calculate them in [{C.CAGG}s](/build/continuous-aggregates).

For examples of the `time_bucket` function, see
[Aggregate time-series data with `time_bucket`](/build/data-management/time-buckets/use-time-buckets).
