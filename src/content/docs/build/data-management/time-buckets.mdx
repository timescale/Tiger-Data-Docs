...
The `time_bucket` function helps you group data in a [hypertable](/build/data-management/setup-hypertables) so you can perform aggregate calculations over arbitrary time intervals. It is usually used in combination with `GROUP BY` for this purpose.
