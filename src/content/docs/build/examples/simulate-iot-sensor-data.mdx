...
keywords: [IoT, simulate, sensor data, time-series, testing, development, sample data]
learnMore:
  ...
  relatedPosts:
    ...
    - label: "Video: Tiger Data workshop, build your IoT database fast with TimescaleDB"
      href: https://www.youtube.com/watch?v=T95QRH7hAzY
    - label: "How Easee consolidated time-series operations across 1M+ chargers with Tiger Data"
      href: https://www.tigerdata.com/case-studies/easee
    - label: "How ControlCom turns 300M+ monthly facility data points into instant answers with Tiger Data"
      href: https://www.tigerdata.com/blog/controlcom-case-study-tiger-data
---

import * as C from "@constants";
import { NumberedList, NumberedItem } from "@components/NumberedList";
import CloudOrSelf from "../../../../partials/_prereqs-cloud-or-self.mdx";
...
testing a new system. This tutorial shows how to simulate a basic dataset in your {C.SERVICE_LONG}, and then run simple queries on it.
...
<NumberedList>
<NumberedItem title="Create the sensors table">
...
<NumberedItem title={`Create the sensor_data ${C.HYPERTABLE}`}>
...
<NumberedItem title="Populate the sensors table">
...
<NumberedItem title="Verify that the sensors have been added correctly">
...
<NumberedItem title="Generate and insert a dataset for all sensors">
...
<NumberedItem title="Verify the simulated dataset">
