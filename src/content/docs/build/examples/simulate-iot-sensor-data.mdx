...
learnMore:
  ...
  relatedPosts:
    ...
    - label: "Robot fleet telemetry: database architecture for AMR, industrial robot, and service robot data"
      href: https://www.tigerdata.com/learn/robot-fleet-telemetry
---
