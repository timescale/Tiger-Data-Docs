---
title: "Integrate Node-RED with Tiger Data"
...
This page shows you how to use Node-RED to write events into your {C.COMPANY} service or database so you can persist, query, and analyze them in a hypertable.
...
- A database user with INSERT privileges on the target database in your {C.SERVICE_LONG} or self-hosted {C.TIMESCALE_DB} instance.
</Prerequisites>
