...
integrationCardLogo: "cloudwatch.png"
integrationCardLogoDark: "cloudwatch-dark.png"
sidebar:
...
- An [Amazon CloudWatch](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/GettingSetup.html) account.
</Prerequisites>
