...
You can export telemetry data from your {C.SERVICE_LONG}s to CloudWatch. See [Exported metrics](/integrate/observability-alerting/exported-metrics) for the full list of default and additional metrics you can export.
