...
[Grafana][grafana] is an open-source analytics and visualization platform that enables you to query, visualize, alert on, and explore your metrics, logs, and traces wherever they're stored.
...
2. **Group your visualizations and order the results by [time buckets][time-bucket]**
   ...
   ![Tiger Cloud and Grafana query results][query-results]
   ...
   ![Tiger Cloud and Grafana query results in time buckets][query-results-time-buckets]
...
3. **Customize the Geomap settings**
   ...
   ![Tiger Cloud and Grafana integration][integration]
...
[integration]: https://assets.timescale.com/docs/images/timescale-grafana-integration.png

[nyc-taxi]: /tutorials/real-time-analytics/transport

[query-results]: https://assets.timescale.com/docs/images/grafana_query_results.png

[query-results-time-buckets]: https://assets.timescale.com/docs/images/grafana_query_results_5m.png
