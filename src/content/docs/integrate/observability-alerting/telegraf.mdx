...
To view metrics gathered by Telegraf and stored in a [{C.HYPERTABLE}][hypertables] in a
{C.SERVICE_LONG}:

- [Link Telegraf to your service][link-telegraf]: create a Telegraf configuration
- [View the metrics collected by Telegraf][view-metrics]: connect to your {C.SERVICE_SHORT} and
...
{C.SERVICE_SHORT} and query the metrics [{C.HYPERTABLE}][hypertables].
...
see the [{C.PG} output plugin][output-plugin].
...
[link-telegraf]: /integrate/observability-alerting/telegraf#link-telegraf-to-your-service

[output-plugin]: https://github.com/influxdata/telegraf/blob/release-1.24/plugins/outputs/postgresql/README.md

[telegraf]: https://www.influxdata.com/time-series-platform/telegraf/

[view-metrics]: /integrate/observability-alerting/telegraf#view-the-metrics-collected-by-telegraf
