...
[Kubernetes][kubernetes] is an open-source container orchestration system that automates the deployment, scaling, and management of containerized applications. You can connect Kubernetes to {C.CLOUD_LONG}, and deploy {C.TIMESCALE_DB} within your Kubernetes clusters.
  ...
  <Tab title={C.CLOUD_LONG}>
    ...
    3. **Configure network access to {C.CLOUD_LONG}**
       ...
       - **Self-hosted Kubernetes**: If your cluster is behind a firewall or running on-premise, you may need to allow
         egress traffic to {C.CLOUD_LONG}. Test connectivity using your [connection details][connection-info]:
