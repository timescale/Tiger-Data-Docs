...
Take the following steps to create a Kafka source connector in {C.CLOUD_LONG}.

1. **In [{C.CONSOLE_SHORT}](https://console.cloud.tigerdata.com/dashboard/services), select your {C.SERVICE_SHORT}**
