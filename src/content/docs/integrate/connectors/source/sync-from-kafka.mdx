...
1. **In [{C.CONSOLE_SHORT}][services-portal], select your {C.SERVICE_SHORT}**
...
[limitations]: /integrate/connectors/source/sync-from-kafka#known-limitations-and-unsupported-types
