...
-   Install the [Postgres client tools](/integrate/query-administration/psql) on your sync machine.
...
2.  **Connect the source database and the target service** ![Postgres connector wizard](https://assets.timescale.com/docs/images/tiger-on-azure/pg-connector-wizard-tiger-console.png)
    ...
    4.  Enter your database credentials or a Postgres connection string, then click `Connect to database`. This is the connection string for [`<pg connector username>`](/integrate/connectors/source/sync-from-postgres#tune-your-source-database). Tiger Console connects to the source database and retrieves the schema information.
