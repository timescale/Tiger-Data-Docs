...
![{C.CLOUD_LONG} overview](https://assets.timescale.com/docs/images/tiger-on-azure/tiger-console-connector-overview.png)
...
2. **Connect the source S3 bucket to the target {C.SERVICE_SHORT}**
   ...
   ![Connect {C.CLOUD_LONG} to S3 bucket](https://assets.timescale.com/docs/images/tiger-on-azure/s3-connector-tiger-console.png)
...
4. **Monitor synchronization**
   ...
   1. To view the amount of data replicated, click `Connectors`.
      ...
      ![{C.CLOUD_LONG} connectors overview](https://assets.timescale.com/docs/images/tiger-on-azure/tiger-console-connector-overview.png)
