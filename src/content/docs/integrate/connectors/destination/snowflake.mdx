...
- {C.LAKE_LONG} set up and active in your {C.SERVICE_LONG}. Follow the [{C.LAKE_LONG} guide](/integrate/connectors/destination/tigerlake) to create one. Note your `S3TableBucketArn` from the CloudFormation stack outputs. You need it throughout this guide.
