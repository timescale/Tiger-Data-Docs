...
<RelatedContentCards>
  <RelatedContentCard
    title={C.ICEBERG_CONNECTOR_SHORT}
    description={`Set up or manage the ${C.ICEBERG_CONNECTOR_SHORT} that syncs your ${C.SERVICE_SHORT} data to Apache Iceberg tables.`}
