...
import imgIcebergConnectorTigerCloud from "../../../../../assets/images/integrate/connectors/iceberg-connector-tiger-cloud.svg?url";

{C.LAKE_LONG} enables you to build real-time applications alongside efficient data pipeline management within a single
system.

<img src={imgIcebergConnectorTigerCloud} alt="Tiger Lake architecture: Iceberg connector in Tiger Cloud" />
