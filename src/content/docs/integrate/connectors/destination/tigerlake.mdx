...
- In order to collect deletes made to data in the columstore, certain columnstore optimizations are disabled for {C.HYPERTABLE}s, this includes [Direct Compress](/build/data-management/understand-hypertables/#speed-up-data-ingestion).
