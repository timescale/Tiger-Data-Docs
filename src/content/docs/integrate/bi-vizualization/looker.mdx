...
<NumberedList>
  ...
  <NumberedItem title="Enter your connection details">
    ...
    Give the connection a name, then from the **Dialect** list select `PostgreSQL 9.5+`. Enter your [connection details](/integrate/find-connection-details):
  ...
  <NumberedItem title="Configure persistent derived tables">
    ...
    Turn on `Enable PDTs` and set the **Temp Database** to `looker_scratch`, the scratch schema you created.
