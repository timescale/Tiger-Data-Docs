...
1. **[Connect](/build/data-management/run-queries-from-tiger-console) to your {C.SERVICE_LONG}**
...
2. **Query your {C.SERVICE_LONG} for all rows in the `accounts` table**
