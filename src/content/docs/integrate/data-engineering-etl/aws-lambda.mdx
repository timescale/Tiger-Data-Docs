...
2. **Create a hypertable to store sensor data**
   ...
   [Hypertables][hypertables-section] are {C.PG} tables that automatically partition your data by time. You interact
...
3. **Set up environment variables**
   ...
   In the following example, use your [connection details][connection-info] to add your {C.SERVICE_LONG} connection settings to your Lambda function:
