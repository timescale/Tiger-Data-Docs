...
This page explains how to integrate your AWS infrastructure with Tiger Cloud using [AWS Transit Gateway](https://aws.amazon.com/transit-gateway/).
...
1. **Create a Peering VPC in [Tiger Console](https://console.cloud.timescale.com/)**
   ...
   2. Choose your region and IP range, name your VPC, then click `Create VPC`:
      ...
      Your service and Peering VPC must be in the same AWS region. The number of Peering VPCs you can create in your project depends on your [pricing plan](/deploy/tiger-cloud/understand/pricing-and-account-management). If you need another Peering VPC, either contact [support@tigerdata.com](mailto:support@tigerdata.com) or change your plan in [Tiger Console](https://console.cloud.timescale.com/).
