...
**count(distinct …):** This SQL function allows you to count the number of distinct values in a column. **pg\_stats view:** This PostgreSQL system view provides detailed statistics about columns, including n\_distinct (estimated number of distinct values).
