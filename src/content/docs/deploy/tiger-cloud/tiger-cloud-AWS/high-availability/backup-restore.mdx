...
In [{C.CONSOLE_SHORT}](https://console.cloud.timescale.com/dashboard/services), select your {C.SERVICE_SHORT} and click `Operations` > `Backup & restore`.
...
In [{C.CONSOLE}](https://console.cloud.timescale.com/dashboard/services), from the `Services` list, ensure the {C.SERVICE_SHORT}
