...
[Create your first Tiger Cloud service in minutes](/get-started/quickstart/create-service)
...
[Install and configure TimescaleDB on your infrastructure](/get-started/choose-your-path/install-timescaledb)
...
[Export your data from Tiger Cloud for self-hosted deployment](/learn/data-management/storage)
...
-   **Do you need compliance certifications?** Check our [security and compliance documentation](/deploy/tiger-cloud/tiger-cloud-aws/high-availability/high-availability).
