...
which allows access to all features. To check which edition you are running, see
[Compare {C.TIMESCALE_DB} editions](/get-started/choose-your-path/timescaledb-editions#check-your-installed-edition).
