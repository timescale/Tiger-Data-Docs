...
import imgPgbouncerPoolingNone from "../../../../assets/images/deploy/mst/pgbouncer-pooling-none.webp";
import imgPgbouncerPoolingEnabled from "../../../../assets/images/deploy/mst/pgbouncer-pooling-enabled.webp";
...
<Image src={imgPgbouncerPoolingNone} alt="Connection flow without connection pooling" />
...
<Image src={imgPgbouncerPoolingEnabled} alt="Connection flow with PgBouncer connection pooling enabled" />
