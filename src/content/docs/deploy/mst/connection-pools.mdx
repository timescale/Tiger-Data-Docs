...
![Connection pooling - pooling disabled](https://assets.timescale.com/docs/images/pgbouncer-pooling-none.webp)
...
![Connection pooling - pooling enabled](https://assets.timescale.com/docs/images/pgbouncer-pooling-enabled.webp)
