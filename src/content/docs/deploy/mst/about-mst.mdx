...
![MST projects](https://assets.timescale.com/docs/images/mst/create-project.png)
...
![MST services list](https://assets.timescale.com/docs/images/mst/services.png)

For more information about getting your first {C.MST_SERVICE_SHORT} up and running, see the
[{C.MST_LONG} installation section](/get-started/choose-your-path/create-mst-service).
...
![MST databases list](https://assets.timescale.com/docs/images/mst/create-database.png)
...
![MST selecting a service configuration plan](https://assets.timescale.com/docs/images/mst/service-plans.png)
