...
## Updates to the Goals flow in the {C.CLOUD_LONG} console

<ChangelogEntry
  title="Updates to the Goals flow in the {C.CLOUD_LONG} console"
  date="2026-06-09"
  tags={["improvement"]}
>
<h2 slot="heading" class="changelog-entry__title">Updates to the Goals flow in the {C.CLOUD_LONG} console</h2>

### What's new

We have updated the Goals flow Actions in {C.CLOUD_LONG} to make them more effective and easier to use.
