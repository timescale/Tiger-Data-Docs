...
- **Continuous aggregates**
    ...
    - **Compress as part of the continuous aggregate refresh policy:** The CAgg refresh policy can now compress {C.CHUNK}s of the materialization hypertable that fall within the refresh window as part of the same job, consolidating what used to require a separate {C.COLUMNSTORE} policy.
