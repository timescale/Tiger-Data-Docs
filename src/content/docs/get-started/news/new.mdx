...
## Updates to the Goals flow in the Tiger Cloud console

<ChangelogEntry
  title="Updates to the Goals flow in the Tiger Cloud console"
  date="2026-05-06"
  tags={["improvement"]}
>
<h2 slot="heading" class="changelog-entry__title">Updates to the Goals flow in the Tiger Cloud console</h2>
