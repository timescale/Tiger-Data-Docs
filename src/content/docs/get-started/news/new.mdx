...
<Image src={imgCreateTigerCloudService} alt="Create a {C.SERVICE_LONG}" />
...
<Image src={imgLivesyncPostgresConsoleConfigInstuctions} alt="Timescale Console livesync {C.PG} instructions" />
