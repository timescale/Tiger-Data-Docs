...
Schema evolution, statistics maintenance, and manual refresh on continuous aggregates now match how developers expect to work with materialized data, without the previous workarounds.
