...
<ChangelogEntry 
  title="Automated chunk tuning GA"
  date="2026-06-26"
  tags={["ga", "improvement"]}
>
...
Automated chunk tuning is now GA for all services. Users can enable the feature for each hypertable through the Explorer without having to request access. 
...
See the [docs](https://www.tigerdata.com/docs/build/performance-optimization/improve-hypertable-performance#automated-tuning) for more information.
