...
<ChangelogEntry
  title="New tutorial: build a SCADA data pipeline with Ignition"
  date="2026-07-07"
  tags={["integration"]}
>
<h2 slot="heading" class="changelog-entry__title">New tutorial: build a SCADA data pipeline with Ignition</h2>
