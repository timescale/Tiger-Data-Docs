...
{C.CLOUD_LONG} now offers support for exporting telemetry data from your {C.CLOUD_LONG} services with the time-series and analytics capability enabled to Azure Monitor. {/* TODO: add link to Azure Monitor integration page once migrated */}
To learn more, see Integrate Azure Monitor with {C.CLOUD_LONG}.
</ChangelogEntry>
