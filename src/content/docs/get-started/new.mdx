...
We have added a new panel in {C.CONSOLE} that walks you through setting up:

- the {C.CLOUD_LONG} command line interface (CLI) for easily controlling your project from your terminal
