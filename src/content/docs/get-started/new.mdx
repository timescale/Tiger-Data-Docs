...
- Parallel index builds: `CREATE INDEX` now uses multiple workers for faster indexing of large tables. Postgres automatically allocates workers based on the table size and the `max_parallel_maintenance_workers` setting.
...
<ChangelogEntry 
  ...
  tags={["new-feature"]}
>
<h2 slot="heading" class="changelog-entry__title">Postgres 18 support</h2>
### Postgres 18 now available
...
<ChangelogEntry 
  ...
  tags={["improvement"]}
>
<h2 slot="heading" class="changelog-entry__title">Enhancements to the Postgres source connector</h2>
### What's new
...
<ChangelogEntry 
  ...
  tags={["new-feature", "security"]}
>
<h2 slot="heading" class="changelog-entry__title">Cross-region backups, Postgres options, and onboarding</h2>
...
## Enhanced service monitoring, TimescaleDB v2.20, and livesync for Postgres

<ChangelogEntry 
  title="Enhanced service monitoring, TimescaleDB v2.20, and livesync for Postgres"
  date="2025-05-30"
  tags={["performance", "new-feature", "deprecation"]}
>
<h2 slot="heading" class="changelog-entry__title">Enhanced service monitoring, TimescaleDB v2.20, and livesync for Postgres</h2>
...
<ChangelogEntry 
  title="In-Console Livesync for Postgres"
  date="2025-03-21"
  tags={["new-feature"]}
>
<h2 slot="heading" class="changelog-entry__title">In-Console Livesync for Postgres</h2>
### Set up in Console
...
<ChangelogEntry 
  title="New region in India, Postgres 17 upgrades, and TimescaleDB on AWS Marketplace"
  date="2025-01-10"
  tags={["region", "new-feature"]}
>
<h2 slot="heading" class="changelog-entry__title">New region in India, Postgres 17 upgrades, and TimescaleDB on AWS Marketplace</h2>
...
<ChangelogEntry 
  title="Postgres 17, feature requests, and Postgres Livesync"
  date="2024-12-20"
  tags={["new-feature", "beta"]}
>
<h2 slot="heading" class="changelog-entry__title">Postgres 17, feature requests, and Postgres Livesync</h2>
### Postgres 17
