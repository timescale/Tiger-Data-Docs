...
5. click `Download the config` in `Download your database config`
6. run command: `psql "<your-service-url>"`
7. run SQL: `SELECT CURRENT_DATE;`
8. expect rows: `SELECT 1 WHERE current_user = 'tsdbadmin' AND current_database() = 'tsdb'`
9. expect rows: `SELECT 1 FROM pg_extension WHERE extname = 'timescaledb'`
10. exit psql
11. click `SQL Editor`
12. run SQL: `SELECT CURRENT_DATE;`
13. expect rows: `SELECT 1 FROM pg_extension WHERE extname = 'timescaledb'`
